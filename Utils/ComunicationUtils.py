...
CALIBRATE_SEND_PARAMS = 0x28
SET_TEST_PARAMS = 0x30
START_TEST = 0x38
SPEED_MEASURE = 0x40
VOLTAGE_MEASURE = 0x48
CURRENT_MEASURE = 0x50
PRESSURE_MEASURE = 0x58
...
def sendFunctionParameters(serial, a, b):
    ...
    message = [START_TRANSMISSION_FRAME, CALIBRATE_SEND_PARAMS_FRAME+len(firstParamData)]
    message.extend(firstParamData)
    message.append(CALIBRATE_SEND_PARAMS_FRAME+len(secondParamData))
